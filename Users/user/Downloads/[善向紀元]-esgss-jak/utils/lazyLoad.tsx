...
export const LazyESGConsole = createLazyComponent(
  () => import('../components/ESGConsole')
);

export const LazyESGDashboard = createLazyComponent(
  () => import('../components/ESGDashboard')
);

export const LazyESGAiAssistant = createLazyComponent(
  () => import('../components/ESGAiAssistant')
);

export const LazyCardGameArena = createLazyComponent(
  () => import('../components/CardGameArena')
);

export const LazyOmniKeyDashboard = createLazyComponent(
  () => import('../components/OmniKeyDashboard')
);
