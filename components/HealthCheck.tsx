    ...
    <div className="space-y-8 animate-fade-in pb-12">
        <div className="flex justify-between items-end">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-3xl font-bold text-white">{isZh ? 'ESG 健檢服務' : 'ESG Assessment Service'}</h2>
                    <p className="text-gray-400">{isZh ? '從「合規」到「創價」的雙軌深度診斷' : 'Dual-Track Diagnosis: Compliance to Value Creation'}</p>
                </div>
            </div>
