        ...
        <div>
          ...
          <div className="flex gap-4 border-b border-white/10 overflow-x-auto no-scrollbar">
              ...
              <button 
                ...
                className={`pb-2 text-sm font-medium transition-colors whitespace-nowrap ${activeTab === 'explorer' ? 'text-celestial-emerald border-b-2 border-celestial-emerald' : 'text-gray-400 hover:text-white'}`}
              >
                  {t.dataExplorer}
              </button>
              <button 
