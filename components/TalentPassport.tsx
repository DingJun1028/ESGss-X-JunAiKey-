        ...
        <div className="glass-panel p-6 rounded-2xl flex flex-col items-center text-center space-y-4">
            ...
            <div className="w-full pt-6 border-t border-white/10 text-left space-y-3">
                ...
                <button 
                    ...
                    className="w-full py-2 mt-4 bg-white/10 hover:bg-white/20 text-white rounded-lg text-xs font-bold flex items-center justify-center gap-2 transition-all border border-white/10"
                >
