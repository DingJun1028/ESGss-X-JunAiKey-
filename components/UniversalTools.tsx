...
export const UniversalTools: React.FC<UniversalToolsProps> = ({ language }) => {
  ...
  return (
    <div className="h-full flex flex-col md:flex-row gap-6 p-4 animate-fade-in relative overflow-hidden">
        {/* Background Ambience */}
        ...
        <div className="w-full md:w-80 flex flex-col gap-6 shrink-0">
            ...
            <div className="flex-1 glass-panel p-6 rounded-2xl border border-white/10 flex flex-col overflow-hidden relative">
                ...
                <div className="flex-1 relative">
                    {/* Visual representation of the 36 agents working */}
        ...
        <div className="flex-1 flex flex-col gap-6">
            <div className="glass-panel p-8 rounded-3xl border border-white/10 flex-1 relative flex flex-col justify-center items-center bg-slate-900/50">
        ...
        <div className="w-full md:w-80 glass-panel p-0 rounded-2xl border border-white/10 flex flex-col overflow-hidden bg-black/80">
